...
// org.springframework.data.redis.connection.RedisPassword; import
...
// @Configuration
// 
// @EnableRedisHttpSession(redisNamespace = "HCM", maxInactiveIntervalInSeconds
// = 3600) public class RedisConfiguration {
// 
...
// configuration.setPassword(REDIS_PASSWORD); return new
