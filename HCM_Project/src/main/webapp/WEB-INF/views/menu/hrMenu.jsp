...
String hrSubLinkLeftMenu [][] = {
		{"/hr/commonCode/roleList.do?role=DT","/hr/commonCode/roleList.do?role=RK","/hr/commonCode/roleList.do?role=PN", "/hr/employee/authManageList.do", "/hr/employee/modify.do", "/hr/employee/registAdmin.do", "/hr/employee/list.do", "/hr/employee/updatePwd.do"},		//hrLeftMenu[0]
