...
<button class="btn btn-primary" onclick="ingBox()">진행중</button>
...
<button class="btn btn-success" onclick="iDidBox()">승인</button>
	<div id="tableOuter">
			...
			<tbody>
				<c:forEach var="dto" items="${lists}">
					...
					<c:choose>
							...
							<c:when test="${dto.sidt_temp_cd eq 'TC000005'}">
						...
						<td style="text-align:center;">
							...
							<br> 기안 &nbsp;&nbsp; <span style="color: MediumSeaGreen;">${dto.appr_name0} ></span> &nbsp;&nbsp;&nbsp; &nbsp;<span style="color: DodgerBlue; font-size: larger;">${dto.appr_name1} &nbsp;></span>&nbsp;&nbsp; ${dto.appr_name2}&nbsp; &nbsp;
							</c:if>
							...
							<span style="display:inline-block; width:7%;"></span>&nbsp;&nbsp;&nbsp; &nbsp;${dto.appr_name1} &nbsp;>
							&nbsp;&nbsp; <span style="display:inline-block; width:10%;"></span>${dto.appr_name2}&nbsp; &nbsp;
							</c:if>
