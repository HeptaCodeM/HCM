...
$(document).ready( function () {
   ...
   //	    autoWidth: true,    //자동 열 조정
     	columnDefs: [{ targets: 0, width: 30 },{ targets: 1, width: 100 },{ targets: 2, width: 5 },{ targets: 3, width: 100 },{ targets: 4, width: 20 }], //열의 너비 조절 0,1,2,3 순임
	    	    ...
	    	    if (d.sidt_temp_cd == 'TC000014') {
	    	        ...
	    	        in2 += '                <tr style="min-height:200px; text-align:center; ">'
	    	         ...
	    	         in2   += '                    <td><a href="#" onclick="detailBoard(' + d.sidb_doc_num + ')"> ' + d.sidb_doc_title + '  </a> <br> <br>'
	    	            + '                     기안일자| ' + formattedDate
	    	            + '                    <td> <img style="width:50px; height:50px; border-radius: 22px;" src="/image/empl1.jpg">' + d.empl_name + '</td>'
	    	            + '                    <td style="text-align:center;"> ';
	    	            if (d.sidb_doc_stat == 2 && d.appr_name2 != undefined && d.appr_flag0 == 1 && d.appr_flag1 == 0) {
	    	            	  
	    	            	in2 += '                  <img style="width:50%;" src="/image/s2a3d2.png">                                                                                                                                                                                                          '
	    	                    + '                  <br> 기안 &nbsp;&nbsp; <span style="color: green;"> ' + d.appr_name0 + ' &nbsp; > </span> &nbsp;&nbsp;&nbsp; &nbsp;<span style="color: blue; font-size: larger;">' + d.appr_name1 + ' &nbsp; > </span>&nbsp;&nbsp; ' + d.appr_name2 + '&nbsp; &nbsp;결재완료                  ';
	    	            	    }  
	    	          
	    	            if (d.sidb_doc_stat == 1 && d.appr_name2 != undefined && d.appr_flag0 == 0 && d.appr_flag1 == 0) {
	    	            	 
	    	            	in2 += '                  <img style="width:50%;" src="/image/s1a3d1.png">                                                                                                                                                                                                          '
	    	                    + '                  <br> 기안 &nbsp;&nbsp; <span style="color: green;">' + d.appr_name0 + ' &nbsp; > </span> &nbsp;&nbsp;&nbsp; &nbsp;<span style="color: blue; font-size: larger;">' + d.appr_name1 + ' &nbsp; > </span>&nbsp;&nbsp; ' + d.appr_name2 + '&nbsp; &nbsp;결재완료                  ';
	    	            }
	    	            if (d.sidb_doc_stat == 2 && d.appr_name2 == undefined && d.appr_flag0 == 1 && d.appr_flag1 == 0) {
	    	            	d.appr_name2 = '';
	    	            	in2 += '                  <img style="width:50%;" src="/image/s2a2d2.png">                                                                                                                                                                                                          '
	    	            	+ '                  <br> 기안 &nbsp;&nbsp; <span style="color: green;"> ' + d.appr_name0 + ' &nbsp; > </span> &nbsp;&nbsp;&nbsp; &nbsp;<span style="color: blue; font-size: larger;">' + d.appr_name1 + '  &nbsp; > </span>&nbsp;&nbsp; ' + d.appr_name2 + '&nbsp; &nbsp;결재완료                  ';
	    	            ...
	    	            in2+= '                        <img style="width:80%;" src="/image/s1.png">'
	    	            }
	    	            if (d.sidb_doc_stat == 2){
	    	            in2+= '                         <img style="width:80%;" src="/image/s2.png">'
	    	            }
	    	            if (d.sidb_doc_stat == 3){
	    	            in2+= '                         <img style="width:80%;" src="/image/s3.png">'
	    	            }
	    	            if (d.sidb_doc_stat ==4){
	    	            in2+= '                          <img style="width:80%;" src="/image/s4.png">'
	    	            }
	    	            + '                    </td>'
	    	            + '                </tr>';
