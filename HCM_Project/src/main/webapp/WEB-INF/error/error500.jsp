...
<div class="d-flex flex-column flex-root" id="kt_app_root">
			<!--begin::Page bg image-->
			<style>body { background-image: url('assets/media/auth/bg11.jpg'); } [data-bs-theme="dark"] body { background-image: url('assets/media/auth/bg11-dark.jpg'); }</style>
			<!--end::Page bg image-->
				...
				<div class="d-flex flex-column flex-center text-center p-10">
					...
					<div class="card card-flush w-lg-650px py-5">
						<div class="card-body py-15 py-lg-20">
							...
							<!--end::Title-->
							<!--begin::Text-->
							<div class="fw-semibold fs-6 text-gray-500 mb-7">서버가 이상합니다 관리자에게 문의하세요.</div>
							<!--end::Text-->
							<!--begin::Illustration-->
							<div class="mb-11">
